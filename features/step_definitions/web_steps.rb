...
Then /^(?:|I )press "([^"]*)" within (.*)$/ do |button, parent|
...
When /^(?:|I )attach the file "([^"]*)" to "([^"]*)"$/ do |path, field|
  attach_file(field, Rails.root.join(path))
end
...
Then /^(?:|I )should see ([^"]*) on the page$/ do |locator|
  page.should have_selector(*selector_for(locator))
end

Then /^(?:|I )should not see ([^"]*) on the page$/ do |locator|
  page.should_not have_selector(*selector_for(locator))
end
...
Then /^sleep for (\d+) seconds$/ do |delay|
  sleep(delay.to_i)
end
...
Given /I accept confirmations/ do
  page.evaluate_script('window.confirm = function() { return true; }')
end

Given /I reject confirmations/ do
